...
use Goldenzero\Generator\Generators\API\APIControllerGenerator;
use Goldenzero\Generator\Generators\API\RepoAPIControllerGenerator;
...
class APIGeneratorCommand extends Command
{
	 ...
	 * @var string
	 */
	protected $name = 'goldenzero.generator:api';
